/* Produced by CVXGEN, 2014-01-13 17:29:12 -0500.  */
...
void setup_pointers(void) {
  ...
  vars.q_5 = work.x + 28;
  vars.q_6 = work.x + 35;
  vars.q_des_cur_1 = work.x + 42;
  vars.q_des_cur_2 = work.x + 49;
  vars.q_des_cur_3 = work.x + 56;
  vars.qd_1 = work.x + 63;
  vars.qd_2 = work.x + 70;
  vars.qd_3 = work.x + 77;
  vars.qd_4 = work.x + 84;
...
double eval_objv(void) {
  ...
  objv += params.alpha[0]*params.posture_weight[0]*work.quad_267328208896[0];
  return objv;
}
...
void fillrhs_cc(void) {
  ...
  double minval;
  r2 = work.rhs + 181;
  ds_aff = work.lhs_aff + 181;
  dz_aff = work.lhs_aff + 411;
  mu = 0;
  for (i = 0; i < 230; i++)
