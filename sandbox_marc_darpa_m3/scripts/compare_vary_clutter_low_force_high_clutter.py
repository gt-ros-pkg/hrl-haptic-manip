...
def return_lists_50_percent_each():
    dyn_skin_nm_list = [
                         ...
                         #'dyn_vs_qs_comparison/dyn_low_force_high_clutter_simple_large_delta_t_impulse_0.04',
                         'dyn_vs_qs_comparison/dyn_low_force_high_clutter_new_delta_t_impulse_sim_anneal_search_set2_mu_15_t_impulse_0.7',
                         #'dyn_vs_qs_comparison/dyn_low_force_high_clutter_simple_large',
    ...
    qs_skin_nm_list = [
                        ...
                        'final_ijrr_results_with_10_second_timeout/75_obstacle_configurations_movable000_fixed080/mpc_qs_1_using_skin',
...
def get_percentages_above_thresh(direc, nm, x_values):
    ...
    for name in nm:
        ...
        #dyn_data = ut.load_pickle(direc+'dyn_vs_qs_comparison/dyn_low_force_high_clutter_simple_large/reach_in_force_statistics.pkl')
        
        dyn_data = ut.load_pickle(direc+'dyn_vs_qs_comparison/dyn_low_force_high_clutter_new_delta_t_impulse_sim_anneal_search_set2_mu_15_t_impulse_0.7/reach_in_force_statistics.pkl')
        #dyn_data = ut.load_pickle(direc+'dyn_vs_qs_comparison/dyn_low_force_high_clutter_simple_large_delta_t_impulse_0.04/reach_in_force_statistics.pkl')
        ...
        qs_data = ut.load_pickle(direc+'final_ijrr_results_with_10_second_timeout/75_obstacle_configurations_movable000_fixed080/mpc_qs_1_using_skin/reach_in_force_statistics.pkl')
...
if __name__ == '__main__':
    ...
    plot_percent_above_threshold = True #True
    ...
    if plot_percent_above_threshold:
        ...
        d = {}
        d['low_high_qs'] = perc_qs_50
        d['low_high_dyn'] = perc_dyn_50
        d['low_high_x'] = x_values

        import scipy.io as io
        io.savemat('/home/mkillpack/Dropbox/low_high_force.mat', d)
        ...
        pp.ylim((0, 20.))
        pp.xlim((4, 17.))
        pp.savefig('contact_force_stats_low_force_high_clutter_new_delta_t_impulse_0.4.pdf')
    ...
    if success_rate_plots:
        ...
        pp.savefig('success_rate_low_force_high_clutter_delta_t_impulse_0.04.pdf')
