...
def fixed_50_percent():
    ...
    pp.plot(obj_count_list, baseline_success_percent, 'y--^', mew=0,
            label='MPC without tactile sensors')
...
def get_percentages_above_thresh(direc, nm, x_values):
    ...
    for name in nm:
        ...
        data_ft = ut.load_pickle(direc+name+'/mpc_qs_1_using_best_ft_sensor/reach_in_force_statistics.pkl')
...
if __name__ == '__main__':
    ...
    n_reaches_for_success = True
    plot_percent_above_threshold = False
