...
void M3TaxelArrayVirtual::Startup()
{
	SetStateSafeOp();
}

void M3TaxelArrayVirtual::Shutdown()
{

}

bool M3TaxelArrayVirtual::LinkDependentComponents()
{
...
void M3TaxelArrayVirtual::StepStatus()
{
//	if (IsStateError())
//		return;
...
void M3TaxelArrayVirtual::StepCommand()
{
