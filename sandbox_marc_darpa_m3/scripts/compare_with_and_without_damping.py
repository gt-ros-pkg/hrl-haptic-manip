...
def return_lists_50_percent_each():
    ...
    qs_skin_nm_list = [
                        ...
                        'dyn_vs_qs_comparison/fixed_000_movable_080_25N_threshold_with_damping_delta_t_impulse_0.02',
...
def get_percentages_above_thresh(direc, nm, x_values):
    ...
    for name in nm:
        ...
        qs_data = ut.load_pickle(direc+'dyn_vs_qs_comparison/fixed_080_movable_000_25N_threshold_with_damping_delta_t_impulse_0.02/reach_in_force_statistics.pkl')
        ...
        print "qs_data.keys() :", qs_data.keys()
...
if __name__ == '__main__':
    ...
    if plot_percent_above_threshold:
        ...
        pp.ylim((0, 40.))
        pp.xlim((24, 35.))
        pp.savefig('contact_force_stats_low_force_high_clutter_delta_t_impulse_0.04.pdf')
