...
if __name__ == '__main__':
    ...
    import plot_contact_loc_data_single as pclds

    base = '/home/mkillpack/Desktop/'

    get_histograms(None, data_dyn, ind_over, force_thresh, num_obst)  #can add prefix and num_bins

    pclds.plot_stuff(data_dyn['contact_force'], data_dyn['contact_locs'],  base+str(force_thresh).zfill(2)+'N_movable000_fixed0'+str(num_obst), thresh_list)
