...
def return_lists_50_percent_each():
    dyn_skin_nm_list = [
                         ...
                         'dyn_vs_qs_comparison/dyn_high_force_high_clutter_delta_t_impulse_0.04',
    ...
    qs_skin_nm_list = [
                        ...
                        'dyn_vs_qs_comparison/dyn_high_force_high_clutter_delta_t_impulse_0.02',
...
def get_percentages_above_thresh(direc, nm, x_values):
    ...
    for name in nm:
        ...
        dyn_data = ut.load_pickle(direc+'dyn_vs_qs_comparison/dyn_high_force_high_clutter_delta_t_impulse_0.04/reach_in_force_statistics.pkl')
        ...
        qs_data = ut.load_pickle(direc+'dyn_vs_qs_comparison/dyn_high_force_high_clutter_delta_t_impulse_0.02/reach_in_force_statistics.pkl')
