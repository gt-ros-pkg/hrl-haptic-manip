...
b_jt_kp = [30., 20., 15.]
b_jt_kd = [15., 10., 8.]
b_jt_limits_max = np.radians([100, 100, 100]).tolist()
b_jt_limits_min = np.radians([-100, -100, -100]).tolist()
b_jt_axis = [[0.,0.,1.],[0.,0.,1.], [0.,0.,1.]]
b_jt_attach = [[0, -1], [1, 0], [2,1]]

b_jt_start = [-1.4819025045766963, 0.52179465524945989, 1.2570233845226708]
