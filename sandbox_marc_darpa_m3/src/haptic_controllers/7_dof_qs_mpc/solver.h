/* Produced by CVXGEN, 2012-06-08 13:24:03 -0700.  */
...
#include "sandbox_marc_darpa_m3/OptTest.h"
#include "sandbox_marc_darpa_m3/OptTestCall.h"
//#include "sandbox_marc_darpa_m3/ServiceBasedMPC.h"
#include "hrl_haptic_manipulation_in_clutter_srvs/ServiceBasedMPC.h"
...
typedef struct Params_t {
  ...
  double KP_t_KP[49];
  double gamma[1];
  double desired_force_decrease[60];
  double n_K_ci_J_ci_max[420];
  double B[49];
  double q_min[7];
  double q_max[7];
  double u_min[7];
...
typedef struct Workspace_t {
  ...
  /* Pre-op symbols. */
  double quad_364777340928[49];
  double quad_923429715968[1];
