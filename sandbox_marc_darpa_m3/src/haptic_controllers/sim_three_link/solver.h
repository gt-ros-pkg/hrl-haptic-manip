...
typedef struct Params_t {
  ...
  double KP_t_KP[9];
  double gamma[1];
  double desired_force_decrease[150];
  double n_K_ci_J_ci_max[450];
  double B[9];
  double q_min[3];
  double q_max[3];
  double u_min[3];
...
typedef struct Workspace_t {
  ...
  /* Pre-op symbols. */
  double quad_631310131200[9];
  double quad_364777340928[9];
  double quad_952907202560[1];
