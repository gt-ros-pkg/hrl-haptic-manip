...
# Robot kinematic classes and skin clients. These are specific to each robot and used to perform forward kinematics.
...
class WaypointGenerator():
  ...
  def initSimCody(self):
    rospy.loginfo("Trajectory generator for: Simulation 7DOF Cody")
