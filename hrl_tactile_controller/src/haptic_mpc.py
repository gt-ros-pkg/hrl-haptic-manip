  ...
  def initRobot(self, robot):
    if robot == "pr2":
      ...
      if self.opt.arm == 'r' or self.opt.arm == 'l':
        ...
        rospy.logerr('Arm not properly specified for PR2 kinematics')
        raise Exception, "Arm must be 'l' or 'r', but '%s' was given instead" %self.opt.arm
    elif robot == "sim3":
      ...
      raise Exception, 'Unknown robot type given. Valid options are: [\'pr2\', \'cody\', \'sim3\', \'simcody\']'
