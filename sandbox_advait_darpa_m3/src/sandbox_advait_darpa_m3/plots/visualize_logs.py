...
def plot_force_histogram(f_mag_l, label, bin_width=0.5):
    ...
    print 'median force:', ss.scoreatpercentile(f_mag_l, 50)
    print '75 percentile force:', ss.scoreatpercentile(f_mag_l, 75)
