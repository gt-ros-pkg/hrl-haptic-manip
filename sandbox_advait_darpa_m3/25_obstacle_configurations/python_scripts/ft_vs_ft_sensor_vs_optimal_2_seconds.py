...
def return_lists_50_percent_each():
    ft_sensor_nm_list = [
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable010_fixed010/mpc_qs_1_using_best_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable020_fixed020/mpc_qs_1_using_best_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable040_fixed040/mpc_qs_1_using_best_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable060_fixed060/mpc_qs_1_using_best_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable080_fixed080/mpc_qs_1_using_best_ft_sensor',
                        ]

    skin_nm_list = [
                    '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable010_fixed010/mpc_qs_1_using_ft_sensor',
                    '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable020_fixed020/mpc_qs_1_using_ft_sensor',
                    '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable040_fixed040/mpc_qs_1_using_ft_sensor',
                    '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable060_fixed060/mpc_qs_1_using_ft_sensor',
                    '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable080_fixed080/mpc_qs_1_using_ft_sensor',
                   ]

    baseline_nm_list = [
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable010_fixed010/mpc_qs_1_using_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable020_fixed020/mpc_qs_1_using_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable040_fixed040/mpc_qs_1_using_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable060_fixed060/mpc_qs_1_using_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable080_fixed080/mpc_qs_1_using_ft_sensor',
                       ]
...
def return_lists_0_percent_fixed():
    ...
    skin_nm_list = [
                     '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable020_fixed000/mpc_qs_1_using_skin',
                     '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable040_fixed000/mpc_qs_1_using_skin',
                     '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable080_fixed000/mpc_qs_1_using_skin',
                     '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable120_fixed000/mpc_qs_1_using_skin',
                     '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable160_fixed000/mpc_qs_1_using_skin',
                   ]
...
def return_lists_100_percent_fixed():
    ft_sensor_nm_list = ['../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable000_fixed020/mpc_qs_1_using_best_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable000_fixed040/mpc_qs_1_using_best_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable000_fixed080/mpc_qs_1_using_best_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable000_fixed120/mpc_qs_1_using_best_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable000_fixed160/mpc_qs_1_using_best_ft_sensor',
                        ]



    skin_nm_list = [        
                     '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable000_fixed020/mpc_qs_1_using_ft_sensor',
                     '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable000_fixed040/mpc_qs_1_using_ft_sensor',
                     '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable000_fixed080/mpc_qs_1_using_ft_sensor',
                     '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable000_fixed120/mpc_qs_1_using_ft_sensor',
                     '../marc_test_new_ft_sensor_includes_moment_2_second_timeout/75_obstacle_configurations_movable000_fixed160/mpc_qs_1_using_ft_sensor',
                   ]

    baseline_nm_list = [
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable000_fixed020/mpc_qs_1_using_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable000_fixed040/mpc_qs_1_using_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable000_fixed080/mpc_qs_1_using_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable000_fixed120/mpc_qs_1_using_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable000_fixed160/mpc_qs_1_using_ft_sensor',
                       ]
...
def compute_success_rate_and_perc_improv(path, pkl_nm, obj_count_list,
    ...
    perc_improv_torque_ft = []
    perc_improv_capped_ft = []

    for ft_nm, skin_nm, bs_nm, or_nm in zip(ft_sensor_nm_list, skin_nm_list, baseline_nm_list, openrave_nm_list):
        ...
        perc_improv_torque_ft.append((ft_success_percent[-1]-skin_success_percent[-1] * 1. ) / skin_success_percent[-1] *100) 
        perc_improv_capped_ft.append((ft_success_percent[-1]-baseline_success_percent[-1]*1. ) / baseline_success_percent[-1] *100) 
    
    return ft_success_percent, skin_success_percent, baseline_success_percent, openrave_success_percent, perc_improv_torque_ft, perc_improv_capped_ft
...
def fixed_0_percent():
    ...
    openrave_success_percent, perc_improv_torque_ft, perc_improv_capped_ft = compute_success_rate_and_perc_improv(path, pkl_nm, obj_count_list,
    ...
    return obj_count_list, perc_improv_torque_ft, perc_improv_capped_ft, ft_success_percent, skin_success_percent
...
def fixed_50_percent():
    ...
    pp.plot(obj_count_list, skin_success_percent, 'b-.s', mew=0, label='FT Sensor Contact with Torque')
    pp.plot(obj_count_list, ft_success_percent, 'g:D', mew=0, label='FT Sensor Contact Off Body')
    pp.plot(obj_count_list, baseline_success_percent, 'y--^', mew=0,
           label='FT Sensor Capped at Link Ends')
...
def fixed_100_percent():
    ...
    pp.plot(obj_count_list, openrave_success_percent, 'r-o', mew=0, label='Estimated optimal')
    pp.plot(obj_count_list, skin_success_percent, 'b-.s', mew=0, label='FT Sensor Contact \n with Torque')
    pp.plot(obj_count_list, ft_success_percent, 'g:D', mew=0, label='FT Sensor Contact\n  Off Body')
    pp.plot(obj_count_list, baseline_success_percent, 'y--^', mew=0,
           label='FT Sensor Capped \n at Link Ends')
    mpu.legend(draw_frame=False, numpoints=20, loc=1 )   #display_mode='less_space')
...
def compare_average_velocity_skin_ft(path, pkl_nm, ft_nm_list, skin_nm_list, ignore_nm_list):
    dist_l_skin = []
    time_l_skin = []
    dist_l_ft = []
    time_l_ft = []
    ...
    for ft_nm, skin_nm, none_nm in zip(ft_nm_list, skin_nm_list, ignore_nm_list):
        d_ft = ut.load_pickle(os.path.join(path, ft_nm, pkl_nm))
        d_skin = ut.load_pickle(os.path.join(path, skin_nm, pkl_nm))
        d_none = ut.load_pickle(os.path.join(path, none_nm, pkl_nm))
        for key in d_skin['success_vel_dict'].keys():
            ...
            if d_skin['success_vel_dict'][key]['success'] == True:
                dist_l_skin.append(d_skin['success_vel_dict'][key]['dist'])
                time_l_skin.append(d_skin['success_vel_dict'][key]['time'])
            if d_ft['success_vel_dict'][key]['success'] == True:
                dist_l_ft.append(d_ft['success_vel_dict'][key]['dist'])
                time_l_ft.append(d_ft['success_vel_dict'][key]['time'])
            if d_none['success_vel_dict'][key]['success'] == True:
                dist_l_none.append(d_none['success_vel_dict'][key]['dist'])
                time_l_none.append(d_none['success_vel_dict'][key]['time'])

    skin_vel_list = np.array(dist_l_skin)/np.array(time_l_skin)
    ft_vel_list = np.array(dist_l_ft)/np.array(time_l_ft)
    none_vel_list = np.array(dist_l_none)/np.array(time_l_none)

    total_dist_skin = np.sum(dist_l_skin)
    total_time_skin = np.sum(time_l_skin)
    total_dist_ft = np.sum(dist_l_ft)
    total_time_ft = np.sum(time_l_ft)
    total_dist_none = np.sum(dist_l_none)
    total_time_none = np.sum(time_l_none)

    print "OTHER WAY TO DO:"
    print "skin :", np.mean(skin_vel_list), np.std(skin_vel_list)
    print "ft :", np.mean(ft_vel_list), np.std(ft_vel_list)
    print "none:", np.mean(none_vel_list), np.std(none_vel_list)
    print "ttest between skin and ft", ss.ttest_ind(ft_vel_list, skin_vel_list)
    print "#################################################################"
    print "#################################################################"
    print "#################################################################"

    return total_dist_ft / total_time_ft,  total_dist_skin / total_time_skin , total_dist_none/total_time_none
...
def plot_perc_contact_forces_above_force_threshold(perc_ft_best, perc_ft_old, perc_ft_torque, x):
    ...
    pp.plot(x, perc_ft_best, 'g:',
            label='FT sensors with off link contact')
    pp.plot(x, perc_ft_old, 'b',
            label='FT sensors capped at link ends')
    pp.plot(x, perc_ft_torque, 'r--',
            label='FT sensors capped with torque')
    pp.xlim(5.5, 20.5)
    pp.ylim(0, max(np.max(perc_ft_best), np.max(perc_ft_old), np.max(perc_ft_torque))+1)
...
def get_percentages_above_thresh(direc, nm, x_values):
    ft_best_total = 0
    ft_best_above = [0]*len(x_values)

    ft_old_total = 0
    ft_old_above = [0]*len(x_values)

    ft_torque_total = 0
    ft_torque_above = [0]*len(x_values)

    none_total = 0
    none_above = [0]*len(x_values)
    ...
    for name in nm:
        ...
        data_ft_best = ut.load_pickle(direc+'../marc_rerun_all_trials_ijrr_revision_2_data/'+name+'/mpc_qs_1_using_best_ft_sensor/reach_in_force_statistics.pkl')
        data_ft_old = ut.load_pickle(direc+'../marc_rerun_all_trials_ijrr_revision_2_data/'+name+'/mpc_qs_1_using_ft_sensor/reach_in_force_statistics.pkl')
        data_ft_torque = ut.load_pickle(direc+'../marc_test_new_ft_sensor_includes_moment_2_second_timeout/'+name+'/mpc_qs_1_using_ft_sensor/reach_in_force_statistics.pkl')

        if data_ft_best == None or data_ft_old == None or data_ft_torque == None:
            print "NO DATA AT :", direc+name
            sys.exit()
  
        ft_best_total = ft_best_total + len(data_ft_best['all_forces_mag_list'])
        ft_old_total = ft_old_total + len(data_ft_old['all_forces_mag_list'])
        ft_torque_total = ft_torque_total + len(data_ft_torque['all_forces_mag_list'])

        for i in xrange(len(x_values)):
            ft_best_above[i] = ft_best_above[i] + len(np.where(np.array(data_ft_best['all_forces_mag_list']) > x_values[i])[0])
            ft_old_above[i] = ft_old_above[i] + len(np.where(np.array(data_ft_old['all_forces_mag_list']) > x_values[i])[0])
            ft_torque_above[i] = ft_torque_above[i] + len(np.where(np.array(data_ft_torque['all_forces_mag_list']) > x_values[i])[0])
            
    ft_best_result = []
    ft_old_result = []
    ft_torque_result = []
    for i in xrange(len(x_values)):
        ft_best_result.append(float(ft_best_above[i])/float(ft_best_total)*100)
        ft_old_result.append(float(ft_old_above[i])/float(ft_old_total)*100)
        ft_torque_result.append(float(ft_torque_above[i])/float(ft_torque_total)*100)

    return ft_best_result, ft_old_result, ft_torque_result, ft_best_total, ft_old_total, ft_torque_total


if __name__ == '__main__':
    success_rate_plots = False
    ...
    if plot_percent_above_threshold:
        ...
        #START HEREEEEEEEEEEEEEEEEEEEEEEEEEEE
        ...
        direc = '/home/mkillpack/hrl_file_server/darpa_m3/final_ijrr_results_with_10_second_timeout/'

        x_values = [6+i*0.125 for i in xrange(81)]
        ...
        perc_ft_best_50, perc_ft_old_50, perc_ft_torque_50, ft_best_total_50, ft_old_total_50, ft_torque_total_50 = get_percentages_above_thresh(direc, nm_50, x_values)

        print "perc_ft_best_50 :\n", perc_ft_best_50
        print "perc_ft_old_50 :\n", perc_ft_old_50
        print "perc_ft_torque_50 :\n", perc_ft_old_50

        plot_perc_contact_forces_above_force_threshold(perc_ft_best_50, perc_ft_old_50, perc_ft_torque_50, x_values)
        pp.title('50\% fixed')
        pp.ylim((0, 6.))
        pp.xlim((5, 17.))
        ...
        perc_ft_best_100, perc_ft_old_100, perc_ft_torque_100, ft_best_total_100, ft_old_total_100, ft_torque_total_100 = get_percentages_above_thresh(direc, nm_100, x_values)

        print "perc_ft_best_100 :\n", perc_ft_best_100
        print "perc_ft_old_100 :\n", perc_ft_old_100
        print "perc_ft_torque_100 :\n", perc_ft_torque_100
    ...
    if average_velocity:
        ...
        ft_avg_vel, skin_avg_vel, none_avg_vel = compare_average_velocity_skin_ft(path, pkl_nm, ft1_l, skin1_l, baseline1_l)
    ...
    if success_rate_plots:
        mpu.set_figure_size(8*2, 8.0)
        fig = pp.figure()
        fig.subplots_adjust(hspace=0.350, wspace=0.01, bottom=0.17,
                            top=0.84, left=0.08, right=0.99)

        # sp1 = pp.subplot(1,2,1)
        ...
        sp2 = pp.subplot(1,2,1)
        obj_l_both, perc_improv_torque_ft_50, perc_improv_capped_ft_50, ft_50, skin_50 = fixed_50_percent()

        print "ft_50 :\n", ft_50
        print "skin_50 :\n", skin_50
        print "p-values :\n", statistical_analysis_success_percent(skin_50, ft_50, 1200)[2]

        sp3 = pp.subplot(1,2,2)
        obj_l_all_fixed, perc_improv_torque_ft_100, perc_improv_capped_ft_100, ft_100, skin_100 = fixed_100_percent()
        ...
        if True:
            ...
            pp.plot(obj_l_all_fixed, perc_improv_torque_ft_100, 'c:s', mew=0)#, label='0\% movable, 100\% fixed')
            pp.plot(np.NaN, np.NaN, 'c:s', mew=0, ms=4., label='100\% fixed')
            print "Comparison including torque for 100\% fixed", perc_improv_torque_ft_100

            pp.plot(obj_l_both,  perc_improv_torque_ft_50, 'm--^', mew=0)#, label='50\% movable, 50\% fixed')
            pp.plot(np.NaN, np.NaN, 'm--^', mew=0, ms=4., label='50\% fixed')
            print "Comparison including torque for 50\% fixed", perc_improv_torque_ft_50
            ...
            mpu.reduce_figure_margins(left=0.205, bottom=0.13, right=0.97, top=0.80)
            pp.title('Comparison Including \n Resultant Contact Torque')
            # params = {'legend.markerscale': 0.01}
            # pp.rcParams.update(params)
            pp.savefig('percent_improvement_over_capped_with_torque.pdf')
            ...
            pp.plot(obj_l_all_fixed, perc_improv_capped_ft_100, 'c:s', mew=0)#, label='0\% movable, 100\% fixed')
            pp.plot(np.NaN, np.NaN, 'c:s', mew=0, ms=4., label='100\% fixed')
            print "Comparison capping at link ends for 100\% fixed", perc_improv_capped_ft_100

            pp.plot(obj_l_both,  perc_improv_capped_ft_50, 'm--^', mew=0)#, label='50\% movable, 50\% fixed')
            pp.plot(np.NaN, np.NaN, 'm--^', mew=0, ms=4., label='50\% fixed')
            print "Comparison capping at link ends for 50\% fixed", perc_improv_capped_ft_50
            ...
            mpu.legend(draw_frame=False)
            mpu.reduce_figure_margins(left=0.205, bottom=0.13, right=0.97, top=0.80)
            pp.title('Comparison for Capping \n at Link Ends')
            # params = {'legend.markerscale': 0.01}
            # pp.rcParams.update(params)
            pp.savefig('percent_improvement_over_capped_only.pdf')
