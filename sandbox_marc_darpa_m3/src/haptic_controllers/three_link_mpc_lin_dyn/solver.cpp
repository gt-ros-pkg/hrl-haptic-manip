...
void setup_pointers(void) {
  ...
  vars.q_4 = work.x + 9;
  vars.q_5 = work.x + 12;
  vars.q_des_cur_1 = work.x + 15;
  vars.q_des_cur_2 = work.x + 18;
  vars.q_des_cur_3 = work.x + 21;
  vars.q_des_cur_4 = work.x + 24;
  vars.q_des_cur_5 = work.x + 27;
  vars.qd_1 = work.x + 30;
  vars.qd_2 = work.x + 33;
  vars.qd_3 = work.x + 36;
  vars.qd_4 = work.x + 39;
...
void fillrhs_cc(void) {
  ...
  double minval;
  r2 = work.rhs + 272;
  ds_aff = work.lhs_aff + 272;
  dz_aff = work.lhs_aff + 752;
  mu = 0;
  for (i = 0; i < 480; i++)
