...
for i = 0:0.01:22.0
    ...
    %delta_x_d = x_g - x_cur;
    if norm(x_g-x_cur) > 0.08
        delta_x_d = (x_g - x_cur)/norm(x_g-x_cur)*0.08;
    else
        delta_x_d = x_g - x_cur;
    end
...
%     robot.plot(q_0)
    ...
    %state_buf = sys_d.a*[qd_0'; q_0'] + sys_d.b*[q_des_cur_0' + vars.u_0; tau_cont_sum_0; q_0']    
...
t_vel_08 = 0:0.01:(length(q_real)-1)*0.01;

save('./humanoids_t_impulse_08.mat', 'q_real', 'qd_real', 'x_vel', ...
    't_vel_08', 'robot', 't_force_08', 'max_forces')
% better plots
