...
#    rospy.set_param('m3/software_testbed/linkage/link_names', mod.bodies['name'])
...
if __name__ == '__main__':
    ...
    p.add_option('--planar_one_link_capsule', action='store_true',
                 dest='po_capsule', help='this specifies a 1 link capsule robot')
    ...
    if opt.po_capsule:
        import hrl_common_code_darpa_m3.robot_config.one_link_planar_capsule as mod
