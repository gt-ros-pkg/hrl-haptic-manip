/* Produced by CVXGEN, 2012-06-06 11:30:50 -0700.  */
...
double eval_objv(void) {
  ...
  objv += params.alpha[0]*work.quad_952907202560[0]+params.gamma[0]*work.quad_923429715968[0];
