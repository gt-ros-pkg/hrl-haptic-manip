...
def get_percentages_above_thresh(direc, nm, x_values):
    ...
    for name in nm:
        ...
        dyn_data_v2 = ut.load_pickle(direc+'dyn_vs_qs_comparison/dyn_high_force_high_clutter_20130624_v2_large_delta_t_impulse_0.02/reach_in_force_statistics.pkl')
