...
#######################################################
# 
# cRoNA2 Return Home Script
# 
########################################################
# script that commands the robot to move back to the home configuration
...
class cRoNA2ReturnHome(object):
    ...
    def return_home(self):
        self.initialize_msg()
	self.base_goal = [0.,0.,0.]
	self.torso_goal = [0.]
	self.head_goal = [0.]
	self.larm_goal = [0.,0.,0.,45.,0.,0.]
	self.rarm_goal = [0.,0.,0.,45.,0.,0.]
...
if __name__ == '__main__':
    rospy.init_node('crona2_return_home')
    c2rh = cRoNA2ReturnHome()
    c2rh.start()
