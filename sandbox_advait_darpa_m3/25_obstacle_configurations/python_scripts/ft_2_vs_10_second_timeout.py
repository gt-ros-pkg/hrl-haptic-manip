...
def return_lists_50_percent_each():
    ft_sensor_nm_list = [
                         ...
                         #'../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable100_fixed100/mpc_qs_1_using_best_ft_sensor',
                        ]

    skin_nm_list = [
                    '75_obstacle_configurations_movable010_fixed010/mpc_qs_1_using_best_ft_sensor',
                    '75_obstacle_configurations_movable020_fixed020/mpc_qs_1_using_best_ft_sensor',
                    '75_obstacle_configurations_movable040_fixed040/mpc_qs_1_using_best_ft_sensor',
                    '75_obstacle_configurations_movable060_fixed060/mpc_qs_1_using_best_ft_sensor',
                    '75_obstacle_configurations_movable080_fixed080/mpc_qs_1_using_best_ft_sensor',
    ...
    baseline_nm_list = [
                        ...
                        #'75_obstacle_configurations_movable100_fixed100/mpc_qs_1_ignore_skin',
                       ]
...
def return_lists_0_percent_fixed():
    ft_sensor_nm_list = [
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable020_fixed000/mpc_qs_1_using_best_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable040_fixed000/mpc_qs_1_using_best_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable080_fixed000/mpc_qs_1_using_best_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable120_fixed000/mpc_qs_1_using_best_ft_sensor',
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable160_fixed000/mpc_qs_1_using_best_ft_sensor',
                         #../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable200_fixed000/mpc_qs_1_using_best_ft_sensor',
                        ]
...
def return_lists_100_percent_fixed():
    ft_sensor_nm_list = [
                         '../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable000_fixed020/mpc_qs_1_using_best_ft_sensor',
                         ...
                         #../marc_rerun_all_trials_ijrr_revision_2_data/75_obstacle_configurations_movable000_fixed200/mpc_qs_1_using_best_ft_sensor',
                        ]

    skin_nm_list = [        
                     '75_obstacle_configurations_movable000_fixed020/mpc_qs_1_using_best_ft_sensor',
...
def fixed_0_percent():
    ...
    #pp.plot(None, None, 'y--^', mew=0, label='MPC without tactile sensors')
    pp.plot(obj_count_list, skin_success_percent, 'b-.s', mew=0, label='10 second timeout')
    pp.plot(obj_count_list, ft_success_percent, 'g:D', mew=0, label='2 second timeout')
    ...
    pp.ylabel('Success percent', labelpad=-1)
...
def get_percentages_above_thresh(direc, nm, x_values):
    ...
    for name in nm:
        ...
        data_ft = ut.load_pickle(direc+'../marc_rerun_all_trials_ijrr_revision_2_data/'+name+'/mpc_qs_1_using_best_ft_sensor/reach_in_force_statistics.pkl')
        data_skin = ut.load_pickle(direc+name+'/mpc_qs_1_using_best_ft_sensor/reach_in_force_statistics.pkl')
        data_none = ut.load_pickle(direc+name+'/mpc_qs_1_ignore_skin/reach_in_force_statistics.pkl')
        ...
        none_total = none_total + len(data_none['all_forces_mag_list'])
        ...
        for i in xrange(len(x_values)):
            ...
            none_above[i] = none_above[i] + len(np.where(np.array(data_none['all_forces_mag_list']) > x_values[i])[0])
    ...
    for i in xrange(len(x_values)):
        ...
        none_result.append(float(none_above[i])/float(none_total)*100)

    return skin_result, ft_result, none_result, skin_total, ft_total, none_total
...
if __name__ == '__main__':
    ...
    if plot_percent_above_threshold:
        ...
        nm_100 = ['75_obstacle_configurations_movable000_fixed020',
                  ...
                  '75_obstacle_configurations_movable000_fixed160',]
                   #   nfigurations_movable000_fixed200']
        ...
        perc_skin_50, perc_ft_50, _, skin_total_50, ft_total_50, _ = get_percentages_above_thresh(direc, nm_50, x_values)
    ...
    if success_rate_plots:
        ...
        if True:
            ...
            pp.title('Percent Improvment for \n 10 second vs 2 second timeout')
