...
def return_lists_50_percent_each():
    dyn_skin_nm_list = [
                         ...
                         'dyn_vs_qs_comparison/dyn_high_force_low_clutter_new_delta_t_impulse_sim_anneal_search_set2_mu_15',
                         #'dyn_vs_qs_comparison/dyn_high_force_low_clutter_simple_large_delta_t_impulse_0.04',
    ...
    qs_skin_nm_list = [
                        ...
                        'final_ijrr_results_with_10_second_timeout/75_obstacle_configurations_movable000_fixed020_25N_thresh/mpc_qs_1_using_skin',
...
def fixed_50_percent():
    ...
    pp.plot(obj_count_list, qs_skin_success_percent, 'b-.s', mew=0, label='Quasi-static MPC')
    pp.plot(obj_count_list, dyn_skin_success_percent, 'g:D', mew=0, label='Dynamic MPC')
...
def get_percentages_above_thresh(direc, nm, x_values):
    ...
    for name in nm:
        ...
        #dyn_data = ut.load_pickle(direc+'dyn_vs_qs_comparison/dyn_high_force_low_clutter_new_delta_t_impulse_sim_anneal_search_set2_mu_20/reach_in_force_statistics.pkl')
        dyn_data = ut.load_pickle(direc+'dyn_vs_qs_comparison/dyn_high_force_low_clutter_new_delta_t_impulse_sim_anneal_search_set2_mu_15/reach_in_force_statistics.pkl')
        ...
        qs_data = ut.load_pickle(direc+'final_ijrr_results_with_10_second_timeout/75_obstacle_configurations_movable000_fixed020_25N_thresh/mpc_qs_1_using_skin/reach_in_force_statistics.pkl')
...
if __name__ == '__main__':
    ...
    if plot_percent_above_threshold:
        ...
        d = {}
        d['high_low_qs'] = perc_qs_50
        d['high_low_dyn'] = perc_dyn_50
        d['high_low_x'] = x_values

        import scipy.io as io
        io.savemat('/home/mkillpack/Dropbox/high_low_force.mat', d)
        ...
        pp.ylim((0, 20.))
        pp.xlim((24, 37.))
        pp.savefig('contact_force_stats_high_force_low_clutter_delta_t_impulse_0.02.pdf')
    ...
    if success_rate_plots:
        ...
        pp.savefig('success_rate_high_force_low_clutter_delta_t_impulse_0.04.pdf')
